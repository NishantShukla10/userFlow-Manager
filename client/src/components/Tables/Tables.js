                        ...
                        <>
                          <tr>
                            ...
                            <td className="text-center">
                              <Dropdown>
                                <Dropdown.Toggle
                                  ...
                                  style={{
                                    backgroundColor: element.status === "Active" ? "#0d6efd" : "#dc3545",
                                    fontSize: "13px",
                                    lineHeight: "1.2",
                                  }}
                                >
                                  {element.status} <i className="fa-solid fa-angle-down ms-1"></i>
                                </Dropdown.Toggle>

                                <Dropdown.Menu>
                                  <Dropdown.Item onClick={() => handleChange(element._id, "Active")}>
                                    Active
                                  </Dropdown.Item>
                                  <Dropdown.Item onClick={() => handleChange(element._id, "InActive")}>
                                    InActive
                                  </Dropdown.Item>
                                </Dropdown.Menu>
                              </Dropdown>
                            ...
                            <td className='img_parent'>
                              <img src={element.profile} alt="img" className="user-profile" />
                            </td>
                            <td>
                              <Dropdown>
